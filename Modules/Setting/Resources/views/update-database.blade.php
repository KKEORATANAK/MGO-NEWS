                            ...
                            <div class="add-new-page  bg-white p-20 m-b-20">
                                <div class="tab-content" id="nav-tabContent">
                                    <div class="tab-pane fade show active" id="general_settings" role="tabpanel">
                                        ...
                                        <div class="row">
                                            @if(settingHelper('version') == "" || settingHelper('version') < 110)
                                            <div class="col-12 m-t-20 text-center">
                                                <div class="alert alert-danger">
                                                    <h4 class="bold">{{__('your_version')}}</h4>
                                                    <span class="font-medium bold">V{{ settingHelper('version') ?? '102' }}({{__('go_to_upgrade')}})</span>
                                        ...
                                        @if(settingHelper('version') == "" || settingHelper('version') < 103)
                                       <div class="row">
