                                ...
                                <nav>
                                    <div class="nav m-b-20 setting-tab" id="nav-tab" role="tablist">
                                        ...
                                        <!--<a class="nav-item nav-link active" id="update-database"
                                           href="{{ route('update-database') }}">{{ __('') }}</a>-->
                                    </div>
                                </nav>
                                ...
                                <div class="tab-content" id="nav-tabContent">
                                    ...
                                    <!--<div class="tab-pane fade show active" id="recaptcha_settings" role="tabpanel">
                                     ...
                                     {{--        <div class="m-b-20">
                                            ...
                                            <div class="mb-2">
                                                <span><strong>{{ __('video_convert') }} {{ __('cpanel_cron_command') }} :</strong> 0,30	*	*	*	* /usr/local/bin/php /home/project_path/artisan videoConverter:cron >> /dev/null 2>&1</span>
                                            ...
                                            <div class="mb-2">
                                                <span><strong>{{ __('schedule_post') }} {{ __('cpanel_cron_command') }} :</strong> *	*	*	*	* /usr/local/bin/php /home/project_path/artisan schedulepost:cron >> /dev/null 2>&1</span>
                                            ...
                                            <div class="mb-2">
                                                <span><strong>{{ __('newsletter') }} {{ __('cpanel_cron_command') }} :</strong> */5	*	*	*	* /usr/local/bin/php /home/project_path/artisan newsletter:cron >> /dev/null 2>&1</span>
                                            ...
                                            <div class="mb-2">
                                                <span><strong>{{ __('rss_auto_update_post_import') }} {{ __('cpanel_cron_command') }} :</strong> 0	0	*	*	* /usr/local/bin/php /home/project_path/artisan rssImport:cron >> /dev/null 2>&1</span>
