                                            ...
                                            <td>
                                                <div class="post-image">
                                                    ...
                                                    <?php if(@$item->is_cover): ?>
                                                        <span class="album-cover"><?php echo e(__('album_cover')); ?></span>
                                                    <?php endif; ?>
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu options-dropdown">
                                                            <?php if(Sentinel::getUser()->hasAccess(['album_write']) and $item->album_id !=''): ?>
                                                                <li>
                                                                    <?php if($item->is_cover!=1): ?>
                                                                        <a href="javascript:void(0)"
                                                                           onclick="set_cover('<?php echo e($item->id); ?>')">
                                                                            <i class="fa fa-plus option-icon"></i><?php echo e(__('set_as_cover')); ?>
...
<?php echo $__env->make('common::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u378727991/domains/mangomedia.net/public_html/Modules/Gallery/Providers/../Resources/views/image_search.blade.php ENDPATH**/ ?>