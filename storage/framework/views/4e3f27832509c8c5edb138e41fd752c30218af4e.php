                                        ...
                                        <div <?php if( settingHelper('mail_driver') =='sendmail'): ?> id="display-nothing"
                                            ...
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input name="mail_host" value="<?php echo e(settingHelper('mail_host')); ?>"
                                            ...
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input name="mail_port" value="<?php echo e(settingHelper('mail_port')); ?>"
                                            ...
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input name="mail_address"
                                                           value="<?php echo e(settingHelper('mail_address')); ?>" id="mail_address"
                                            ...
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input name="mail_name" value="<?php echo e(settingHelper('mail_name')); ?>"
                                            ...
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input name="mail_password"
                                                           value="<?php echo e(settingHelper('mail_password')); ?>"
...
<?php echo $__env->make('common::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u378727991/domains/mangomedia.net/public_html/Modules/Setting/Providers/../Resources/views/email_setting.blade.php ENDPATH**/ ?>