<div class="add-new-page content_<?php echo e($content_count); ?> bg-white p-20 m-b-20" id="image_content_<?php echo e($content_count); ?>">
    ...
    <div class="row">
        ...
        <div class="col-12 p-t-20 p-l-15">
            <div class="row">
                <div class="col-md-4">
                    <label for="" class="col-form-label"><?php echo e(__('content')); ?></label>
                    <textarea class="form-control" name="new_content[<?php echo e($content_count); ?>][text-image-text][text_1]" id=""
                      cols="40" rows="5"><?php echo e(isset($content)? $content['text-image-text'][0]['text_1']:''); ?></textarea>
                </div>
                <div class="col-md-4">
                    <div class="col-12">
                        <div class="row">
                        ...
                        <input id="image_id_content" name="new_content[<?php echo e($content_count); ?>][text-image-text][image_id]" type="hidden" class="form-control image_id" value="<?php echo e(isset($content)? $content['text-image-text'][1]['image_id']:''); ?>">
                                </div>
                            </div>
                            <div class="col-md-8">
                                <div class="form-group">
                                    <div class="form-group text-center">
                                        <?php if(isset($content) && $content['text-image-text'][1]['image_id'] != ""): ?>
                ...
                <div class="col-md-4">
                    <label for="" class="col-form-label"><?php echo e(__('content')); ?></label>
                    <textarea class="form-control" name="new_content[<?php echo e($content_count); ?>][text-image-text][text_2]" id=""
                      cols="40" rows="5"><?php echo e(isset($content)? $content['text-image-text'][2]['text_2']:''); ?></textarea>
                </div>
...
<?php /**PATH /home/u378727991/domains/mangomedia.net/public_html/Modules/Post/Providers/../Resources/views/contents/text-image-text.blade.php ENDPATH**/ ?>