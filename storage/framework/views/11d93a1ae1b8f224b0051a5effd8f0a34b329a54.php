...
<?php $__env->startSection('content'); ?>
    <div class="dashboard-ecommerce">
        <div class="container-fluid dashboard-content ">
            <!-- page info start-->
            <?php echo Form::open(['route'=>['update-post','audio',$post->id],'method' => 'post','enctype'=>'multipart/form-data']); ?>
                            ...
                            <div class="add-new-page  bg-white p-20 m-b-20">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" value="<?php echo e($post->meta_title); ?>" id="meta_title"
                                               name="meta_title">
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="selected-audios">
                                            <span id="audio_thumb">
                                                <?php $__currentLoopData = @$post->audio; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php if(isFileExist($item, @$item->original)): ?>
                                                        <div class="audio-item audio_<?php echo e($item->id); ?> mb-1" id="<?php echo e($item->id); ?>">
                                                            <input id="<?php echo e($item->id); ?>" name="audio[]" type="hidden" value="<?php echo e($item->id); ?>">
                                                            <div class="left"><i class="fa fa-music"></i></div>
                                                            <div class="center"><?php echo e($item->audio_name); ?></div>
...
<?php echo $__env->make('common::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u378727991/domains/mangomedia.net/public_html/Modules/Post/Providers/../Resources/views/audio_post_edit.blade.php ENDPATH**/ ?>