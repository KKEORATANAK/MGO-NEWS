    ...
    <div class="header-bottom">
        <div class="container">
            <div class="d-flex justify-content-between">
                ...
                <a class="navbar-brand align-self-center" href="<?php echo e(route('home')); ?>"><img src="<?php echo e(static_asset(settingHelper('logo'))); ?>" alt="Logo" class="img-fluid"></a>
            </div>
        </div><!-- /.container -->
    </div><!-- /.header-bottom -->
...
<?php /**PATH /home/u378727991/domains/mangomedia.net/public_html/resources/views/site/layouts/header/style_4.blade.php ENDPATH**/ ?>