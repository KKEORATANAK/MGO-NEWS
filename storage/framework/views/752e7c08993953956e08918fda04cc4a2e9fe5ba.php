            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="col-12">
                        ...
                        <input id="image_id_content" name="new_content[<?php echo e($content_count); ?>][image-text][image_id]" type="hidden" class="form-control image_id" value="<?php echo e(isset($content)? $content['image-text'][0]['image_id']:''); ?>">
                                </div>
                            </div>
                            <div class="col-md-8">
                                <div class="form-group">
                                    <div class="form-group text-center">
                                        <?php if(isset($content) && $content['image-text'][0]['image_id'] != ""): ?>

                                        <?php
                                        $image = $content['image-text'][0]['image'];
                ...
                <div class="col-md-6">
                    ...
                    <textarea class="form-control" name="new_content[<?php echo e($content_count); ?>][image-text][text]" id="" cols="60" rows="10"><?php echo e(isset($content)? $content['image-text'][1]['text']:''); ?></textarea>
                </div>
            </div>
        </div>
    </div>
</div>
<?php /**PATH /home/u378727991/domains/mangomedia.net/public_html/Modules/Post/Providers/../Resources/views/contents/image-text.blade.php ENDPATH**/ ?>