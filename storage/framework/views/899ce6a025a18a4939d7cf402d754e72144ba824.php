...
<div class="nav-left-sidebar sidebar-dark">
                        ...
                        <li class="nav-item">
                            ...
                            <div id="submenu-111" class="collapse submenu <?php echo $__env->yieldContent('s-show'); ?>">
                                <ul class="nav flex-column">
                                    ...
                                    <li class="nav-item ">
                                        <a class="nav-link <?php echo $__env->yieldContent('update-database'); ?>" href="<?php echo e(route('update-database')); ?>">
    ...
    <!-- end left sidebar -->
    <!-- ============================================================== -->
<?php /**PATH /home/u378727991/domains/mangomedia.net/public_html/mgotv/Modules/Common/Providers/../Resources/views/layouts/left-sidebar.blade.php ENDPATH**/ ?>