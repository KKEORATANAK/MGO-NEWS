                            ...
                            <div class="add-new-page  bg-white p-20 m-b-20">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input id="meta_title" class="form-control" value="<?php echo e(old('meta_title')); ?>"
                                               name="meta_title">
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label for="post_desc">
                                            <b><?php echo e(__('description')); ?></b> (<?php echo e(__('meta_tag')); ?>)]
                                        </label>
...
<?php echo $__env->make('common::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u378727991/domains/mangomedia.net/public_html/Modules/Post/Providers/../Resources/views/article_create.blade.php ENDPATH**/ ?>