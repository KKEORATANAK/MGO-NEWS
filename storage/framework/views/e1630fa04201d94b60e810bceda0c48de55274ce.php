        ...
        <div class="col-12 p-t-20 p-l-15">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <textarea class="form-control" name="new_content[<?php echo e($content_count); ?>][text-image][text]" id="" cols="60" rows="10"><?php echo e(isset($content)? $content['text-image'][0]['text']:''); ?></textarea>
                </div>
                <div class="col-md-6">
                    <div class="col-12">
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                data-target=".image-modal-lg"><?php echo e(__('add_image')); ?></button>
                                    <input id="image_id_content" name="new_content[<?php echo e($content_count); ?>][text-image][image_id]" type="hidden" class="form-control image_id" value="<?php echo e(isset($content)? $content['text-image'][1]['image_id']:''); ?>">
                                </div>
                            </div>
                            <div class="col-md-8">
                                <div class="form-group">
                                    <div class="form-group text-center">
                                        <?php if(isset($content) && $content['text-image'][1]['image_id'] != ""): ?>
...
<?php /**PATH /home/u378727991/domains/mangomedia.net/public_html/Modules/Post/Providers/../Resources/views/contents/text-image.blade.php ENDPATH**/ ?>