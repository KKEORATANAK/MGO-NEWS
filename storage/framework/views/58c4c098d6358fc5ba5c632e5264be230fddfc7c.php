...
<?php $__env->startSection('post'); ?>
    active
<?php $__env->stopSection(); ?>
<?php $__env->startSection('recommended-post-active'); ?>
    active
<?php $__env->stopSection(); ?>
                                        ...
                                        <tr id="row_<?php echo e($post->id); ?>">
                                            ...
                                            <td width="10%">
                                                <input type="number" class="form-control btn btn-light" name="order[]"
                                                       value="<?php echo e($post->editor_picks); ?>">
                                            ...
                                            <?php if(Sentinel::getUser()->hasAccess(['post_write'])): ?>
                                                <td>
                                                    <a href="javascript:void(0)"
                                                       onclick="remove_post_form('other','editor_picks','<?php echo e($post->id); ?>')"
...
<?php echo $__env->make('common::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u378727991/domains/mangomedia.net/public_html/Modules/Post/Providers/../Resources/views/recommended_posts.blade.php ENDPATH**/ ?>