                        ...
                        <?php if(@$ad->ad_type == 'image'): ?>
                            <a href="<?php echo e(data_get($ad, 'ad_url', '#')); ?>">
                                <?php if(isFileExist(@$ad->adImage, $result = @$ad->adImage->original_image)): ?>
                                    <img class="img-fluid" src="<?php echo e(safari_check() ? basePath(@$ad->adImage).'/'.$result : static_asset('default-image/default-add-728x90.png')); ?> " data-original="<?php echo e(basePath($ad->adImage)); ?>/<?php echo e($result); ?>" alt="<?php echo e($ad->ad_name); ?>">
                                <?php else: ?>
...
<?php endif; ?>
<?php /**PATH /home/u378727991/domains/mangomedia.net/public_html/mgotv/resources/views/site/partials/ads.blade.php ENDPATH**/ ?>