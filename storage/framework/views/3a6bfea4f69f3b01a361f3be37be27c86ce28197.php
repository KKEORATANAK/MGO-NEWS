                    ...
                    <div class="sg-post">
                       <?php echo $__env->make('site.partials.home.category.first_post', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        <div class="entry-content">
                            ...
                            <p> <?php echo strip_tags(\Illuminate\Support\Str::limit($firstPost->content, 155)); ?></p>
                        </div>
                    </div>
                </div>
            <?php endif; ?>
                    ...
                    <?php $__currentLoopData = $blockPosts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-md-6">
                            <div class="sg-post small-post">
                                <?php echo $__env->make('site.partials.home.category.block', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                <div class="entry-content">
...
<?php /**PATH /home/u378727991/domains/mangomedia.net/public_html/resources/views/site/partials/home/category/style_1.blade.php ENDPATH**/ ?>