             ...
             <div class="d-md-flex justify-content-md-between">
                 <div class="left-contennt">
                     <div class="logo-text-wrap">
                         <h1><a class="" href="<?php echo e(route('home')); ?>"><img src="<?php echo e(static_asset(settingHelper('logo'))); ?>" alt="Logo" class="img-fluid"></a></h1>
                     </div>
                 </div><!-- /.left-contennt -->
                         ...
                         <div class="sg-user ml-4 mt-2">
                             <?php if(Cartalyst\Sentinel\Laravel\Facades\Sentinel::check()): ?>
                                 <div class="dropdown">
                                     <a class="nav-user-img" href="#" id="navbarDropdownMenuLink2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                         ...
                                         <?php endif; ?>
                                             <?php echo e(Sentinel::getUser()->first_name); ?><i class="fa fa-angle-down  ml-2" aria-hidden="true"></i>
                                     </a>
                             ...
                             <?php else: ?>
                                 <span>
                                    ...
                                    <a href="<?php echo e(route('site.login.form')); ?>"><?php echo e(__('login')); ?></a> / <a href="<?php echo e(route('site.register.form')); ?>"> <?php echo e(__('sign_up')); ?></a>
                                </span>
                             <?php endif; ?>
                         </div>
                     </div>
                     ...
                     <div class="sg-post small-post">
                         <div class="entry-header">
                             <div class="entry-thumbnail">
                                 <a href="<?php echo e(route('article.detail', ['id' => $lastPost->slug])); ?>">
                                     <?php if(isFileExist(@$lastPost->image, $result = @$lastPost->image->small_image)): ?>
                                         <img src="<?php echo e(safari_check() ? basePath(@$lastPost->image).'/'.$result : static_asset('default-image/default-240x160.png')); ?> " data-original=" <?php echo e(basePath($lastPost->image)); ?>/<?php echo e($result); ?> " class="img-fluid"   alt="<?php echo $lastPost->title; ?>"  >
                                     <?php else: ?>
                                         <img src="<?php echo e(static_asset('default-image/default-240x160.png')); ?> "  class="img-fluid"   alt="<?php echo $lastPost->title; ?>" >
                                     <?php endif; ?>
                                 </a>
                             </div>
                             <?php if($lastPost->post_type=="video"): ?>
                                 <div class="video-icon">
                                     <img src="<?php echo e(static_asset('default-image/video-icon.svg')); ?> " alt="video-icon">
                                 </div>
                             <?php elseif($lastPost->post_type=="audio"): ?>
                                 <div class="video-icon">
                         ...
                         <div class="entry-content absolute">
                             <div class="category">
                                 <ul class="global-list">
                                     <?php if(isset($lastPost->category)): ?>
                                        <li><a href="<?php echo e(url('category',$lastPost->category->slug)); ?>"><?php echo e(@$lastPost->category->category_name); ?></a></li>
                                     <?php endif; ?>
                                 </ul>
                             </div>
                             <p><a href="<?php echo e(route('article.detail', ['id' => $lastPost->slug])); ?>"><?php echo e(\Illuminate\Support\Str::limit(@$lastPost->title, 30)); ?></a></p>
                         </div><!-- /.entry-content -->
                     </div>
                 </div>
                 <?php endif; ?><!-- /.right-content -->
             </div>
         </div><!-- /.container -->
     </div><!-- /.sg-topbar -->
         ...
         <nav class="navbar navbar-expand-lg">
             <div class="container">
                 <div class="menu-content">
                     <a class="navbar-brand p-0 sm-logo" href="index.html"><img src="<?php echo e(static_asset(settingHelper('logo'))); ?>" alt="Logo" class="img-fluid mt-2"></a>
...
<?php /**PATH /home/u378727991/domains/mangomedia.net/public_html/resources/views/site/layouts/header/style_2.blade.php ENDPATH**/ ?>