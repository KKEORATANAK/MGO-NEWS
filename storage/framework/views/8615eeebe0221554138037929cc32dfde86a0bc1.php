...
<?php $__env->startSection('content'); ?>
    ...
    <div class="dashboard-ecommerce">
        <div class="container-fluid dashboard-content ">
            <!-- page info start-->
            <?php echo Form::open(['route'=>['update-social', $socialMedia->id],'method' => 'put', 'enctype'=>'multipart/form-data']); ?>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="block-header">
                                        <h2><?php echo e(__('update_social')); ?></h2>
                                    </div>
                                </div>
                    ...
                    <div class="add-new-page  bg-white p-20 m-b-20">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <input id="name" value="<?php echo e($socialMedia->name); ?>" name="name" type="text"
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <input id="url" name="url" value="<?php echo e($socialMedia->url); ?>" type="text"
                                       class="form-control">
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <input id="page-title" value="<?php echo e($socialMedia->icon); ?>" name="icon" type="text"
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <input id="page-title" value="<?php echo e($socialMedia->icon_bg_color); ?>" name="icon_bg_color"
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <input id="page-title" value="<?php echo e($socialMedia->text_bg_color); ?>" name="text_bg_color"
                                       type="color" class="form-control" required>
                            </div>
                        </div>
                            ...
                            <div class="col-3 col-md-2">
                                <label class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" name="status" id="status_yes" value="1"
                                           <?php echo e($socialMedia->status == 1?'checked':''); ?> class="custom-control-input">
                            ...
                            <div class="col-3 col-md-2">
                                <label class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" name="status" id="status_no" value="0"
                                           <?php echo e($socialMedia->status == 0?'checked':''); ?>  class="custom-control-input">
                            ...
                            <div class="col-12">
                                <div class="form-group form-float form-group-sm">
                                    <button type="submit" class="btn btn-primary float-right m-t-20"><i
                                            class="mdi mdi-plus"></i> <?php echo e(__('update_social')); ?></button>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('common::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u378727991/domains/mangomedia.net/public_html/Modules/Social/Providers/../Resources/views/social_edit.blade.php ENDPATH**/ ?>