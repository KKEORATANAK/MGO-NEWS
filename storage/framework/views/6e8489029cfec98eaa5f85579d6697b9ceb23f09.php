...
<?php $__env->startSection('post'); ?>
    active
<?php $__env->stopSection(); ?>
<?php $__env->startSection('editor-picks-active'); ?>
    active
<?php $__env->stopSection(); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="dashboard-ecommerce">
        <div class="container-fluid dashboard-content ">
            <!-- page info start-->
            <?php echo Form::open(['route'=>'update-recommended-order','method' => 'post','enctype'=>'multipart/form-data']); ?>
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="block-header">
                                            <h2><?php echo e(__('recommended_posts')); ?></h2>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <tr id="row_<?php echo e($post->id); ?>">
                                            ...
                                            <td class="td-post-sp">
                                                ...
                                                <?php if($post->editor_picks==1): ?>
                                                    <label class="label bg-teal label-table"><?php echo e(__('editor')); ?></label>
                                                <?php endif; ?>
                                            </td>
                                            <td width="10%">
                                                <input type="number" class="form-control btn btn-light" name="order[]"
                                                       value="<?php echo e($post->recommended_order); ?>">
                                            ...
                                            <?php if(Sentinel::getUser()->hasAccess(['post_write'])): ?>
                                                <td>
                                                    <a href="javascript:void(0)"
                                                       onclick="remove_post_form('other','recommended','<?php echo e($post->id); ?>')"
...
<?php echo $__env->make('common::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u378727991/domains/mangomedia.net/public_html/Modules/Post/Providers/../Resources/views/editor_picks.blade.php ENDPATH**/ ?>