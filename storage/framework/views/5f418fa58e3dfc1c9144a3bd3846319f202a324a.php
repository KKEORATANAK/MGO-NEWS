...
<?php $__env->startSection('content'); ?>
    ...
    <div class="dashboard-ecommerce">
        <div class="container-fluid dashboard-content ">
            <!-- page info start-->
            <?php echo Form::open(['route' => 'store-widget','method' => 'post', 'enctype'=>'multipart/form-data']); ?>
            ...
            <div class="row clearfix">
                <div class="col-12">
                    <div class="add-new-page  bg-white p-20 m-b-20">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="block-header">
                                        <h2><?php echo e(__('add_widget')); ?></h2>
                                    </div>
                                </div>
                        ...
                        <div class="col-sm-12 ">
                            <div class="form-group">
                                <label for="language"><?php echo e(__('content_type')); ?></label>
                        ...
                        <div class="col-sm-12 d-none" id="poll-area">
                            <div class="form-group">
                                <label for="language"><?php echo e(__('polls')); ?></label>
                                <select class="form-control" name="poll" id="poll">
                                    <?php $__currentLoopData = $polls; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $poll): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($poll->id); ?>"><?php echo e($poll->question); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="col-12">
                                <div class="form-group form-float form-group-sm">
                                    <button type="submit" class="btn btn-primary float-right m-t-20"><i
                                            class="mdi mdi-plus"></i><?php echo e(__('add_widget')); ?></button>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('common::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u378727991/domains/mangomedia.net/public_html/Modules/Widget/Providers/../Resources/views/create.blade.php ENDPATH**/ ?>