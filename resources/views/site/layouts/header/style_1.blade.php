<header class="sg-header">
    <div class="sg-topbar">
        <div class="container">
            ...
            <div id="11737b7e8793f839d11b6c26f3c7282a" class="ww-informers-box-854753"><p class="ww-informers-box-854754"><a href="https://world-weather.info/forecast/cambodia/phnom_penh/14days/">world-weather.info</a><br><a href="https://world-weather.info/forecast/usa/new_orleans/">https://world-weather.info/forecast/usa/new_orleans/</a></p></div><script async type="text/javascript" charset="utf-8" src="https://world-weather.info/wwinformer.php?userid=11737b7e8793f839d11b6c26f3c7282a"></script><style>.ww-informers-box-854754{-webkit-animation-name:ww-informers54;animation-name:ww-informers54;-webkit-animation-duration:1.5s;animation-duration:1.5s;white-space:nowrap;overflow:hidden;-o-text-overflow:ellipsis;text-overflow:ellipsis;font-size:12px;font-family:Arial;line-height:18px;text-align:center}@-webkit-keyframes ww-informers54{0%,80%{opacity:0}100%{opacity:1}}@keyframes ww-informers54{0%,80%{opacity:0}100%{opacity:1}}</style>
            
            <div class="d-md-flex justify-content-md-between">
                <div class="left-contennt">
                    <ul class="global-list">11
                            ...
                            <div class="sg-language">
                                <select name="code" id="languges-changer">
                                    @foreach ($activeLang as $lang)
                                        <option data-class="{{$lang->icon_class}}" value="{{$lang->code}}" {{ LaravelLocalization::setLocale() == ""? ( settingHelper('default_language') == $lang->code? 'selected':'' ) : (LaravelLocalization::setLocale() == $lang->code ? 'selected':'') }}>{{ $lang->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                            ...
                            @foreach($primaryMenu as $mainMenu)
                                ...
                                @if($mainMenu->is_mega_menu == 'tab')
                                    ...
                                    <li class="sg-dropdown mega-dropdown">
                                        <a href="{{menuUrl($mainMenu)}}">{{$mainMenu->label == 'gallery'? __('gallery'):$mainMenu->label}}<span><i class="fa fa-angle-down" aria-hidden="true"></i></span></a>
